...
1. **Address PIN code: fixed to 734005.** The site said Platinum Square, Siliguri 734001, which is the Siliguri head office PIN. The Union Bank branch in the same building lists "Platinum Square, S.F Road, Siliguri 734005", and the S F Road post office PIN is 734005. The site now uses "Platinum Square, Station Feeder Road, Siliguri, West Bengal 734005". Use exactly this address on the Google Business Profile and every directory listing.
2. **Brand entity is almost invisible off-site.** Searching "AD JEET Siliguri" returns the actor Jeet and unrelated businesses; no Justdial, IndiaMART or Sulekha listing for AD JEET was found. AI assistants and Google's local pack both draw on these third-party mentions. In order: claim or verify the Google Business Profile (category "Sign shop"), then create consistent Justdial, IndiaMART and Bing Places listings with the same name, address, phone and website. Add those profile URLs to `sameAs` in `lib/seo.ts` once they exist.

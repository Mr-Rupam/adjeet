...
export const homeFaqs = [
  ...
  },
  {
    ...
    a: 'Yes. Start with your logo, a reference or a photo of the space. We work through the artwork, material and dimensions before fabrication at our Siliguri workshop, then coordinate installation for the agreed site and scope.',
  },
  {
    q: 'How do I request a quote from AD JEET?',
    a: `WhatsApp or call ${business.phoneDisplay}, email ${business.email}, or use the contact form. Include the service you need, your town, approximate size and target date so the team can discuss the right next step.`,
  },
]

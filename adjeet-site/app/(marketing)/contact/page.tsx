...
export const metadata = buildPageMetadata({
  ...
  description: "Call or WhatsApp +91 98320 11524 for signage, printing and outdoor advertising in North Bengal. AD JEET office: Platinum Square, Siliguri.",
  path: "/contact",
})
    ...
    <>
      ...
      <section className="field-container contact-layout">
        <aside className="contact-intro">
          ...
          <a className="contact-location-link" href="https://www.google.com/maps/search/?api=1&query=Platinum+Square+Siliguri" target="_blank" rel="noopener noreferrer">
            <span className="spec">Plan your visit</span><strong>Platinum Square, Siliguri</strong><span>Find the office in Google Maps ↗</span>
          </a>
        </aside>
